...
public class Q6PartD {
    ...
    public static double getPercentageOfLeasedPlotsWithCrop(CommunityGarden garden, char category) {
        int numOfLeasedPlots = 0;
        int numOfLeasedPlotsWithCrop = 0;
        ...
        for (int i = 1; i <= numPlots; i++) {
            ...
            if (farmer != null) {
                ...
                if (crop != null) {
                    char cropCategory = crop.getCategory();
                    if (cropCategory == category) {
                        numOfLeasedPlotsWithCrop++;
                    }
                }
            }
        }

        return numOfLeasedPlotsWithCrop * 100.0 / numOfLeasedPlots;
    }
}